...
function button13(button13) {
	document.getElementById("button13").innerHTML = button13;
}
function button23(button23) {
	document.getElementById("button23").innerHTML = button23;
}
function button33(button33) {
	document.getElementById("button33").innerHTML = button33;
}
